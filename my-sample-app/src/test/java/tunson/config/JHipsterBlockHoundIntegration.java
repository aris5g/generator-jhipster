...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tunson.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tunson.security.DomainUserDetailsService", "createSpringSecurityUser");
