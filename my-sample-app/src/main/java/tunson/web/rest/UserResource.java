...
import tunson.config.Constants;
import tunson.domain.User;
import tunson.repository.UserRepository;
import tunson.security.AuthoritiesConstants;
import tunson.service.MailService;
import tunson.service.UserService;
import tunson.service.dto.AdminUserDTO;
import tunson.web.rest.errors.BadRequestAlertException;
import tunson.web.rest.errors.EmailAlreadyUsedException;
import tunson.web.rest.errors.LoginAlreadyUsedException;

/**
 * REST controller for managing users.
 * <p>
 * This class accesses the {@link tunson.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    @Value("${jhipster.clientApp.name:iep}")
